...
Update: The annotated data in this repository are outdated. We recommend using the updated data in the new repository [here](https://github.com/geoai-lab/Geo-knowledge-guided-GPT-models-for-disaster-response/tree/main/data)  
